...
public class ToShape implements DrawMode {
	...
	public ToShape(int primitiveShape, int minStateSizeMult, int maxStateSizeMult,
			int minStateFillColor, int maxStateFillColor, int minStateOpacity, int maxStateOpacity,
			boolean showStroke) {
