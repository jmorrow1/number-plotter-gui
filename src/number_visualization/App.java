...
public class App extends PApplet {
	...
	public static void main(String[] args) {
		PApplet.main("number_visualization.App");
	}
	...
	public void setSequence(String name) {
		switch (name) {
			case "Integers" : sequence = integers; break;
			case "Multiples" : sequence = multiples; break;
			case "Powers" : sequence = powers; break;
			default : System.out.println("Don't know any sequence by the name of " + name); break;
		}
		redraw();
	}
	...
	public void setCurve(String name) {
		switch (name) {
			case "Diamond" : curve = diamond; break;
			case "Ulam Spiral" : curve = ulamSpiral; break;
			case "Typewriter" : curve = typewriter; break;
			case "Triangle" : curve = triangle; break;
			default: System.out.println("Don't know any curve by the name of " + name); break;
		}
		redraw();
	}
	...
	public void setProperty(String name) {
		switch (name) {
			case "Divisible by" : property = isDivisibleBy; break;
			case "Any Power" : property = isAnyPower; break;
			case "Random" : property = random; break;
			case "Prime" : property = isPrime; break;
			default : System.out.println("Don't know any property by the name of " + name);
		}
		redraw();
	}
	...
	public void setDrawMode(String name) {
		switch (name) {
			case "Vector" : drawMode = toShape; break;
			case "Char" : drawMode = toChar; break;
			default : System.out.println("Don't know any draw mode by the name of " + name);
		}
		redraw();
	}
	...
	private void drawPoints() {
		for (int n=0; n<pts.length; n++) {
			if (pts[n] != null) {
				...
				drawMode.draw(n, property.evaluate(y), property.numPossibleStates()-1, cellSize*pts[n].x, cellSize*pts[n].y, numberSize, g);
			}
		}
	}
